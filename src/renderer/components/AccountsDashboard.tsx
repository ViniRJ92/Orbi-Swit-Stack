      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* Fase 41: rolagem discreta, folga à direita para a barra não
                encostar nos campos, e respiro no rodapé. */}
            <div className="mw-scroll flex-1 overflow-y-auto py-4 pb-6 pl-5 pr-3">
              {sorted.length === 0 ? (
